...
#ifndef TRAINBLEPERIPHERAL_H
#define TRAINBLEPERIPHERAL_H
 ...
 */
extern void TrainBLEPeripheral_Init( uint8 task_id );

/*
 * Task Event Processor for the BLE Application
 */
extern uint16 TrainBLEPeripheral_ProcessEvent( uint8 task_id, uint16 events );
